  ...
  while(1) {
	...
	break;
      ...
      case SR_RANDOM_DELAY: {
        ...
        // Set up TC0
        TCCR0 &= (0<<CS00) | (0<<CS01) | (0<<CS02) | (0<<WGM00) | (0<<WGM01); // set TC0 timer into normal mode and disable clock
        ...
        do {
    	    ...
    	    TIFR |= (1<<TOV0);                         // manually clear the TC0 overflow flag
    	    // note that thecounter will automatically keep counting upward again
    ...
    case SR_TIMING_USER: {
      ...
      TCCR1B &= (0<<ICNC1) | (0<<WGM12) | (0<<WGM13) | (0<<CS10) | (0<<CS11) | (0<<CS12);  // disable noise canceler, set WGM1{3,2} to 0, and disable clock
      TCCR1A = 0x00;                    // disable all of the output compare pins and set WGM1{1,0} to 0
      TIMSK &= (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TICIE1);         // disable TC1 interrupts in TIMSK
      ...
      TCCR1B |= (1<<CS10) | (1<<CS12);                                           // start TC1 counter
      ...
      numticks = TCNT1;
      TCCR1B &= (0<<CS10) | (0<<CS12);                    // stop the TC1 counter
